...
DATASET_PATH = '/ppbda_vs/backdoor_attacks/poisoned-tiny-imagenet'.format(pawsey_id)
LABEL_PATH = '/ppbda_vs/backdoor_attacks/tiny_img_class_list.txt'.format(pawsey_id)
...
print("Saving model...")
# add absolute path
model.save("/backdoor_attacks/poisoning_binary_classifier_model_imagenet.h5")
print("Model saved")
